...
export default function Header() {
  ...
  return (
    <motion.header
      ...
      className="text-center mb-12 bg-opacity-50 bg-gray-100 dark:bg-opacity-50 dark:bg-gray-800 p-8 rounded-lg shadow-lg"
    >
      ...
      <div className="flex flex-wrap justify-center items-center gap-6 mb-6">
        <p className="flex items-center gap-2">
          <span className="text-accent">📍</span> Chipledhunga - 9, Pokhara, Kaski, Nepal
        </p>
        <p className="flex items-center gap-2">
          <span className="text-accent">📞</span> +977 9846359074
        </p>
        <p className="flex items-center gap-2">
          <span className="text-accent">📧</span> sarun.hirachan@gmail.com
        </p>
        <a
      ...
      <p className="max-w-4xl mx-auto text-justify leading-relaxed">
